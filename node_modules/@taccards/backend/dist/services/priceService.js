...
export async function fetchCardHedgePrice(externalId, gradeLabel = 'raw') {
    try {
        ...
        return {
            price: res.data.fmv,
            confidence: res.data.confidence_grade,
            source: 'cardhedge',
        };
    }
    catch (err) {
...
export async function fetchCardHedgeSalesHistory(externalId, gradeLabel = 'raw', limit = 50) {
    try {
...
export async function syncCardPrices(cardId) {
...
export async function fetchEbayPrices(query, marketId = 'EBAY_IT') {
