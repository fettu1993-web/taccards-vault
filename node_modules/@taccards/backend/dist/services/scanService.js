...
export async function identifyCardFromImage(imageBase64, userId) {
    // 1. Prova CardSight AI
    try {
        const res = await axios.post(`${CARDSIGHT_BASE}/identify`, { image: imageBase64, include_pricing: false }, {
            headers: {
...
export async function confirmScan(scanLogId, confirmedCardId) {
